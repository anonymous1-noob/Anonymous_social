-- Avatar storage bucket and policies for user profile images.
-- Run this in Supabase after the main schema so authenticated users can upload
-- their own profile avatar into storage under avatars/<auth uid>/filename.
